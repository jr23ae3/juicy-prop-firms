...
export const metadata = createPageMetadata({
  ...
  description:
    "How affiliate relationships work at Juicy Trades and why they never affect our rankings.",
...
export default function AffiliateDisclosurePage() {
  return (
    ...
    >
      <p>
        Juicy Trades participates in affiliate programs with some prop firms.
        When you use our discount codes or sign up through our links, we may
        earn a commission at no extra cost to you.
      </p>
      <h2>Rankings are independent</h2>
      <p>
        Affiliate relationships never influence our firm scores, AI advisor
      ...
      <p>
        ...
        Codes shown on Juicy Trades are tested regularly and marked with
