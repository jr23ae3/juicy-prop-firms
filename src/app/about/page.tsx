...
export const metadata = createPageMetadata({
  title: "About",
  description:
    "Learn about Juicy Trades — independent futures prop firm comparisons with verified pricing and transparent rankings.",
  path: "/about",
});
...
export default function AboutPage() {
  return (
    <ContentPage
      eyebrow="About"
      title="About Juicy Trades"
      description="Independent prop firm research built for futures traders."
    >
      <p>
        Juicy Trades helps traders compare futures prop firms with clarity.
      ...
      <p>
        ...
        built Juicy Trades to cut through the noise with verified data and
