...
export const metadata = createPageMetadata({
  ...
  description: "Terms governing your use of Juicy Trades.",
  path: "/terms",
});
...
export default function TermsPage() {
  return (
    <ContentPage title="Terms of Service" description="Last updated: August 2026">
      <p>
        By using Juicy Trades, you agree to these terms. If you do not agree,
        please do not use our services.
      </p>
      <h2>Service description</h2>
      <p>
        Juicy Trades provides prop firm comparison data, rankings, and tools
      ...
      <p>
        Site content, rankings methodology, and branding are owned by Juicy Trades.
        You may not scrape, redistribute, or resell our data without permission.
      </p>
      <h2>Limitation of liability</h2>
      <p>
        Juicy Trades is provided &quot;as is.&quot; We are not liable for losses
