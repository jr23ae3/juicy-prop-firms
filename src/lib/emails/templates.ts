  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f4f4f5;padding:32px 16px;">
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e4e4e7;">
        <tr><td style="background:#00b97a;padding:24px 28px;">
...
export function buildWelcomeEmail(name: string | null) {
  ...
  return {
    ...
    html: emailLayout(`
      ...
      <a href="${siteConfig.url}/compare" style="display:inline-block;background:#00b97a;color:#04110a;text-decoration:none;padding:12px 20px;border-radius:6px;font-size:14px;font-weight:600;">Compare plans</a>
    `),
  };
}
...
export function buildSubscriptionConfirmationEmail(name: string | null) {
  ...
  return {
    ...
    html: emailLayout(`
      ...
      <a href="${siteConfig.url}/account" style="display:inline-block;background:#00b97a;color:#04110a;text-decoration:none;padding:12px 20px;border-radius:6px;font-size:14px;font-weight:600;">Manage account</a>
    `),
  };
}
